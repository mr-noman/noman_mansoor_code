...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=['/home/noman/yolov5x/exp20_1280_high_85/weights/best.pt','/home/noman/yolov5x/exp10_1280_84_low/weights/best.pt'], help='model.pt path(s)')
    parser.add_argument('--batch-size', type=int, default=27, help='batch size')
    ...
    parser.add_argument('--verbose',default=1, action='store_true', help='report mAP by class')
    parser.add_argument('--save-txt', default=1, action='store_true', help='save results to *.txt')
    parser.add_argument('--save-hybrid', action='store_true', help='save label+prediction hybrid results to *.txt')
    parser.add_argument('--save-conf', default=1, action='store_true', help='save confidences in --save-txt labels')
